...
![Heading level 1 in Tine's command palette](docs/heading-level-command.png)

The focused block after applying level 1:

![A level-1 heading rendered in Tine](docs/heading-level-result.png)
...
The [original plugin's screencast](https://raw.githubusercontent.com/vipzhicheng/logseq-plugin-heading-level-shortcuts/40b5a57577d4ab168dea38614eebe3b42085b665/screencast.gif)
is useful for comparing the source behavior; the screenshots above show this port
running in Tine.
